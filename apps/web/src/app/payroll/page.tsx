...
import { crearPeriodoForm } from './actions'
import { ESTADO_PERIODO } from './estados'
import { BotonEnvio } from '@/components/BotonEnvio'

export const dynamic = 'force-dynamic'
export const metadata = { title: 'Nomina · REGB ERP' }
    ...
    <Shell {...shell} activePath="/payroll">
      <div className="space-y-5">
        ...
        {periodos.length === 0 ? (
          <EmptyState
            icon="group"
            title="Todavia no hay ningun periodo de nomina"
            description="Crea el primero abajo con sus fechas, y desde /payroll/run procesalo para calcular TSS e ISR de cada empleado activo."
          />
        ) : (
          <Table>
            <THead>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <p className="mt-1 text-xs text-[var(--color-text-muted)]">
                ...
                para calcular TSS e ISR de cada empleado activo.
              </p>
            </CardBody>
          </Card>
        )}
